    ...
    <table cellspacing="0" cellpadding="0" border="0" class="internal" style="width: 85%;">
        <tr>
            ...
            <td width="25%" style="vertical-align: middle;">
                <input width="100%" type="text" name="invoice_api_key" placeholder="���� API Invoice" value="<?= COption::GetOptionString("invoice.payment", "invoice_api_key", "");?>">
            </td>
        </tr>
        <tr>
            <td>����� �� ������� �������� Invoice</td>
        ...
        <tr>
            <td>
                ��� ������ ����� �������� � <a href="https://lk.invoice.su/">������ �������� Invoice</a>
            </td>
            <td></td>
        </tr>
        <tr>
            <td width="25%" style="vertical-align: middle;">
                <input type="submit" name="invoice_settings_submit" value="���������">
            </td>
            <td></td>
        </tr>
    </table>
