...
include($_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/invoice.payment/lib/RestClient.php');
include($_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/invoice.payment/lib/TerminalInfo.php');
include($_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/invoice.payment/lib/PaymentInfo.php');
include($_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/invoice.payment/lib/CREATE_TERMINAL.php');
include($_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/invoice.payment/lib/CREATE_PAYMENT.php');
include($_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/invoice.payment/lib/common/ORDER.php');
include($_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/invoice.payment/lib/common/SETTINGS.php');
include($_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/invoice.payment/lib/common/ITEM.php');
...
class InvoiceProcessing
{
    ...
    public function __construct()
    {
        ...
        $this->terminal_id = COption::GetOptionString("invoice.payment", 'invoice_terminal', '');
        $this->initTerminal();
    }
    ...
    private function getTransactionId($order_id) {
        return COption::GetOptionString('invoice.payment', 'invoice_tran_'.$order_id, '');
    }
